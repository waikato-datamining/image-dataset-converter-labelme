...
Saves the bounding box/polygon definitions in a labelme .json file alongside the image.

```
usage: to-labelme-od [-h] [-l {DEBUG,INFO,WARNING,ERROR,CRITICAL}]
                     [-N LOGGER_NAME]
...
Saves the bounding box/polygon definitions in a labelme .json file alongside
the image.
